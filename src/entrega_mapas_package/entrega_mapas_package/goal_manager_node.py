...
class GoalManagerNode(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameter('map_buffer', 1.5)
        ...
        # Obstáculos conocidos (puedes ampliar esto leyendo de un topic)
    ...
    def load_obstacles(self):
        ...
        """
        # Hardcodeados por ahora (del script original)
        obstacle_names = ['Rectangle', 'Rectangle0', 'Rectangle1', 'Rectangle2',
                         'Rectangle3', 'Rectangle4', 'Rectangle5']
        obstacle_size = 0.3
        
        # En una implementación real, obtendrías esto de CoppeliaSim o un mapa
    ...
    def is_in_obstacle(self, position):
        ...
        # En implementación real, verificarías contra self.obstacles
